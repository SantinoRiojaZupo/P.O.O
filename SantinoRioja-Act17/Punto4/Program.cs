...
en cadena de los constructores (desde la raíz hasta la clase derivada).*/
{
       ...
       public Material(string TipoMaterial)
        {
            ...
            Console.WriteLine("Constructor de clase Material Ejecutado, tipo de material:"+tipoMaterial);
        }
    ...
    class Herramienta : Material {
        ...
        public Herramienta(string FuncionPrincipal, string TipoMaterial) : base (TipoMaterial)
        {
            ...
            Console.WriteLine("Constructor de clase Herramienta Ejecutado, funcion principal:" + funcionPrincipal);
        }
    ...
    internal class Martillo : Herramienta 
    {
        ...
        public Martillo(float PesoGramos, string FuncionPrincipal, string TipoMaterial) : base (FuncionPrincipal, TipoMaterial) { 
        pesoGramos = PesoGramos;
            Console.WriteLine("Constructor de clase Martillo Ejecutado, peso en gramos:" + pesoGramos);
        }
       
        static void Main(string[] args)
        {
            Martillo martillo1 = new Martillo(20.67f,"Martillar","Hierro");
            Console.ReadKey();
        }
    }
}
